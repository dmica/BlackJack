...
def calculate_score(cards):
  ...
  #Inside calculate_score() check for a blackjack (a hand with only 2 cards: ace + 10) and return 0 instead of the actual score. 0 will represent a blackjack in game.
...
def play_game():
  ...
  #Rechecked score with every new card drawn.
